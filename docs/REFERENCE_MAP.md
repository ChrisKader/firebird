...
| FRB-STRUCT-002 | During Phase 5 core cleanup, place code in subsystem folders (`core/cpu`, `core/debug`, `core/memory`, `core/storage`, `core/peripherals`, `core/usb`) instead of creating new top-level `core/*.c*` files | https://github.com/qt-creator/qt-creator, https://doc.qt.io/qtcreator-extending/coding-style.html, https://doc.qt.io/qt-6.5/model-view-programming.html | `core/*`, `CMakeLists.txt`, `docs/PROJECT_STRUCTURE.md` | partial |
