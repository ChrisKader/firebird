...
| FRB-STRUCT-002 | During Phase 5 core cleanup, move split units into `core/` subsystem subfolders (debug/usb/memory/cpu/peripherals) instead of creating new top-level `core/*.c*` files | https://github.com/qt-creator/qt-creator, https://doc.qt.io/qtcreator-extending/coding-style.html, https://doc.qt.io/qt-6.5/model-view-programming.html | `core/*`, `CMakeLists.txt`, `docs/PROJECT_STRUCTURE.md` | partial |
